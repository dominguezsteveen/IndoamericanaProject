...
class AdminProgramaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $program->img = "images/web/inicio/sections/programas/piloto-1080.webp";
        ...
        $program->img = "images/web/inicio/sections/programas/AuxVuelo.webp";
        $program->urlRedirect = Str::slug($program->titulo);
        ...
        $program->img = "images/web/inicio/sections/programas/MECA-1080.webp";
        $program->urlRedirect = Str::slug($program->titulo);
        ...
        $program->img = "images/web/inicio/sections/programas/TURISMO-MUJER-1080.webp";
        $program->urlRedirect = Str::slug($program->titulo);
        ...
        $program->img = "images/web/inicio/sections/programas/DESPACHO-1080-X-1080.webp";
        ...
        $program->img = "images/web/inicio/sections/programas/CONTINUADA-1.webp";
        $program->urlRedirect = Str::slug($program->titulo);
